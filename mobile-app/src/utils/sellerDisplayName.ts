...
export const handleWithoutAt = (username?: string): string =>
...
export interface SellerPublicProfile {
  /** Pour « ¿Cómo fue tu experiencia con …? » */
  experienceLabel: string;
  /** Nom principal dans la puce vendeur */
  chipName: string;
  /** @username sous le nom tienda (virtual/física) */
  handleLine: string;
  avatar: string;
}
 ...
 * Aligné sur SellerProfileCard / ChatScreen / SellerReviewsScreen.
 */
export function sellerPublicProfileFromUserData(

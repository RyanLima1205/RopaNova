...
export const addPaymentMethod = async (
  userId: string,
  paymentMethod: Omit<PaymentMethod, "id" | "createdAt" | "updatedAt" | "lastUsed">,
): Promise<string> => {
  try {
    ...
    logger.error("Error al agregar el método de pago:", error)
    throw error
  }
}
...
export const getPaymentMethods = async (userId: string): Promise<PaymentMethod[]> => {
  try {
    ...
    logger.error("Error al obtener los métodos de pago:", error)
    throw error
  }
}
...
export const updatePaymentMethod = async (
  ...
  try {
    ...
    logger.error("Error al actualizar el método de pago:", error)
    throw error
  }
}
...
export const deletePaymentMethod = async (userId: string, paymentMethodId: string): Promise<void> => {
  try {
    ...
    logger.error("Error al eliminar el método de pago:", error)
    throw error
  }
}
...
export const setDefaultPaymentMethod = async (userId: string, paymentMethodId: string): Promise<void> => {
  try {
    ...
    logger.error("Error al definir el método por defecto:", error)
    throw error
  }
}
...
export const getWalletData = async (userId: string): Promise<WalletData | null> => {
  try {
    ...
    logger.error("Error al obtener la billetera:", error)
    throw error
  }
}
...
export const updateWalletBalance = async (userId: string, amount: number, type: "add" | "subtract"): Promise<void> => {
  try {
    ...
    logger.error("Error al actualizar el saldo:", error)
    throw error
  }
}
...
export const getTransactionsPaginated = async (
  ...
  try {
    ...
    const q = cursor ? query(ref, ...baseConstraints, startAfter(cursor)) : query(ref, ...baseConstraints)
    ...
    logger.error("Error al obtener las transacciones paginadas:", error)
...
export const addTransaction = async (userId: string, transaction: Omit<Transaction, "id" | "createdAt">): Promise<string> => {
  try {
    ...
    logger.error("Error al agregar la transacción:", error)
    throw error
  }
}
...
export const getPaymentPreferences = async (userId: string): Promise<PaymentPreferences | null> => {
  try {
    ...
    logger.error("Error al obtener las preferencias:", error)
    throw error
  }
}
...
export const updatePaymentPreferences = async (userId: string, preferences: Partial<PaymentPreferences>): Promise<void> => {
  try {
    ...
    logger.error("Error al actualizar las preferencias:", error)
    throw error
  }
}

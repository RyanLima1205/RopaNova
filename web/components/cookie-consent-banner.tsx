...
export function CookieConsentBanner() {
  ...
  const savePreferences = async (prefs: CookiePreferences) => {
    ...
    localStorage.setItem("ropanova-cookie-consent", JSON.stringify(prefs))
    localStorage.setItem("ropanova-cookie-consent-date", new Date().toISOString())
              ...
              <>
                <div className="space-y-3">
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Utilizamos cookies para mejorar tu experiencia en RopaNova, personalizar contenido, analizar el

...
export function CookieSettingsPage() {
  ...
  useEffect(() => {
    ...
    const consent = localStorage.getItem("ropanova-cookie-consent")
    const consentDate = localStorage.getItem("ropanova-cookie-consent-date")
  ...
  const savePreferences = async () => {
    ...
    localStorage.setItem("ropanova-cookie-consent", JSON.stringify(preferences))
    localStorage.setItem("ropanova-cookie-consent-date", now)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600">Controla qué tipos de cookies quieres permitir en RopaNova</p>
        </div>
      </div>

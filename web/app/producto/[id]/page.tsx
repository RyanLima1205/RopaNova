  ...
  useEffect(() => {
    ...
    const fetchProduct = async () => {
      ...
      if (productData) {
        ...
        setIsLiked(Boolean(productData.isLiked))
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4">
        <div className="flex gap-3">
          ...
          <Link href={`/producto/${product.id}/comprar`} className="flex-1">
            <Button className="w-full bg-emerald-500 hover:bg-emerald-600">Comprar Ahora</Button>
          </Link>
        </div>
      </div>
    </div>

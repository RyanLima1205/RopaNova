        ...
        <div className="bg-white rounded-lg p-4 border">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h2 className="font-semibold text-gray-900 mb-2">Términos y Condiciones de RopaNova</h2>
          ...
          <div className="p-6 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
                <p>
                  <strong>RopaNova</strong> es una plataforma digital que conecta compradores y vendedores de ropa y
                  accesorios de segunda mano en República Dominicana.
                </p>
                <p>
                  <strong>Usuario:</strong> Cualquier persona que accede y utiliza los servicios de RopaNova.
                </p>
                <p>
                ...
                <p>Estos términos se aplican a todos los usuarios de RopaNova en territorio dominicano.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
                <p>RopaNova facilita envíos a través de:</p>
                <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
                ...
                <p>RopaNova se reserva el derecho de suspender o eliminar cuentas que violen estas normas.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
                <p>RopaNova actúa como intermediario entre compradores y vendedores.</p>
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
                <p>RopaNova puede modificar estos términos en cualquier momento.</p>
        ...
        <div className="bg-white rounded-lg p-4 border">
          ...
          <div className="space-y-2 text-sm text-gray-600">
            ...
            <div className="space-y-1">
              <p>
                <strong>Email:</strong> legal@ropanova.com
              </p>
              <p>
                <strong>Dirección:</strong> [Completar con la dirección legal de RopaNova], Santo Domingo
              </p>
              <p>
                <strong>RNC:</strong> [Completar con el RNC de RopaNova]
              </p>
            </div>
          </div>
        </div>

        <LegalDocsLinks current="/terminos" />

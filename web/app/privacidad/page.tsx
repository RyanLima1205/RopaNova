  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="bg-white rounded-lg p-4 border">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <h2 className="font-semibold text-gray-900 mb-2">Política de Privacidad de RopaNova</h2>
        ...
        <div className="bg-white rounded-lg border">
          <div className="p-6 space-y-8">
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
                <p>Como usuario de RopaNova, tienes los siguientes derechos:</p>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-4">
                  <p className="text-sm text-blue-800">
                    <strong>Para ejercer estos derechos:</strong> Contáctanos en privacidad@ropanova.com o desde la
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
                <p>RopaNova está diseñado para usuarios mayores de 18 años.</p>
                <ul className="list-disc list-inside space-y-1 ml-4">
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
                ...
                <p>El uso continuado de RopaNova después de los cambios constituye aceptación de la nueva política.</p>
              </div>
            </section>
          </div>
        </div>
          ...
          <div className="space-y-3 text-sm text-gray-600">
            ...
            <div className="bg-gray-50 rounded-lg p-3 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span>privacidad@ropanova.com</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="font-medium">Oficial de Protección de Datos:</span>
                <span>dpo@ropanova.com</span>
              </div>
              <div className="flex items-start gap-2">
                <span className="font-medium">Dirección:</span>
                <span>
                  [Completar con la dirección legal de RopaNova]
                  <br />
        ...
        <LegalDocsLinks current="/privacidad" />
